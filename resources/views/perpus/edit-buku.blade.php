...
<div class="col-md-10 content">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="/buku/update/{{$data_buku->id}}" method="POST" enctype="multipart/form-data">
                @csrf
                <p>
                    <label>Seri Buku</label><br>
                    <input type="text" name="seri" value="{{$data_buku->judul_seri}}" class="form-control"><br>
                </p>
                <p>
                    <label>Judul Buku</label><br>
                    <input type="text" name="judul" value="{{$data_buku->judul}}" class="form-control"><br>
                </p>
                <p>
                    <label>Edisi</label><br>
                    <input type="text" name="edisi" value="{{$data_buku->edisi}}" class="form-control"><br>
                </p>
                <p>
                    <label>Slug</label><br>
                    <input type="text" name="slug" value="{{$data_buku->slug}}" class="form-control"><br>
                </p>
				<p>
                    <label>Gambar Sampul</label><br>
                    <input type="file" accept="image/*" value="{{$data_buku->gambar_sampul}}" name="gambar_sampul"><br>
                </p>
                <p>
