...
<!-- tabel tambah data -->
    <div class="col-md-10 content">
        <center><font size="5">Edit Data Rak Penyimpanan</font></center>
        <hr>
        <form method="POST" action= "{{url('')}}/rak/update/{{$data_rak->id}}">
        @csrf
		<div style="padding:0px 250px 0px;">
            <label class="form-label">Nama Lokasi</label>
            <input type="text" class="form-control" name="nama_lokasi" value="{{$data_rak->nama_lokasi}}" style="width:100%; margin:0px 0px 20px;">
        </div>
		<div style="padding:0px 250px 0px;">
            <label class="form-label">Kode Lokasi</label>
            <input type="text" class="form-control" name="kode_lokasi" value="{{$data_rak->kode_lokasi}}" style="width:100%; margin:0px 0px 20px;">
        </div>
		<div style="padding:0px 250px 0px;">
            <label class="form-label">Nomor Lokasi</label>
            <input type="text" class="form-control" name="nomor_lokasi" value="{{$data_rak->nomor_lokasi}}" style="width:100%; margin:0px 0px 20px;">
        </div>
